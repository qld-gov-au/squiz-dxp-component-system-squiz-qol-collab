export const ssq_design_system = `
    <!-- CSS -->
    <link rel="stylesheet" href="https://ssqld-web-uat.matrix.squiz.cloud/__data/assets/git_bridge/0018/1377/assets/css/qld.bootstrap.css">   
`;
